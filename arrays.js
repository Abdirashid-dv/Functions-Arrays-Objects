...
console.log(
  `Last car is a ${inventory[lastCar]["car_make"]} Model is ${inventory[lastCar]["car_model"]}`
);
...
for (let mod_indx = 0; mod_indx < carModels.length; mod_indx++) {
  carModelsSorted.push(carModels.sort()[mod_indx]);
}
